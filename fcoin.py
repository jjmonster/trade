...
class fcoin():
    ...
    def buy_market(self,symbol,price,amount,type = 'market'):
        return self.buy(symbol,price,amount,type=type)
    ...
    def sell_market(self,symbol,price,amount,type = 'market'):
        return self.sell(symbol,price,amount,type=type)
